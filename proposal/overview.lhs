...
\abstract{
  ...
  Haskell that uses purely functional data structures to manage data stored on
  disk.  No external database tools are used so the system remains lightweight
  and does not compromise the functional paradigm.
